...
<body>
    <x-header></x-header>
    <div class="container border border-secondary-subtle my-1 pb-3 py-2 px-3 bg-white">
        <div class="row">
    ...
    <div class="container border border-secondary-subtle my-2 py-2 px-3 bg-white">
