...
<body>
    ...
    @else
        <div class="mt-1">
            <img src="{{Storage::url('news/'.$news->id.'.'.$news->image)}}" alt="" style="width: 100%; height: 190px; object-fit: cover; background-repeat: no-repeat">
        </div>
        <div class="pt-3 pb-5 px-3 bg-white" style="overflow:auto; max-height: 80vh">
